...
BOOL _CommandBars::GetDisableCustomize()
{
	BOOL result;
...
void _CommandBars::SetDisableCustomize(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL _CommandBars::GetDisableAskAQuestionDropdown()
{
	BOOL result;
...
void _CommandBars::SetDisableAskAQuestionDropdown(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void _CommandBars::ExecuteMso(LPCTSTR idMso)
{
	static BYTE parms[] =
		VTS_BSTR;
...
BOOL _CommandBars::GetEnabledMso(LPCTSTR idMso)
{
	BOOL result;
	static BYTE parms[] =
		VTS_BSTR;
...
BOOL _CommandBars::GetVisibleMso(LPCTSTR idMso)
{
	BOOL result;
	static BYTE parms[] =
		VTS_BSTR;
...
BOOL _CommandBars::GetPressedMso(LPCTSTR idMso)
{
	BOOL result;
	static BYTE parms[] =
		VTS_BSTR;
...
CString _CommandBars::GetLabelMso(LPCTSTR idMso)
{
	CString result;
	static BYTE parms[] =
		VTS_BSTR;
...
CString _CommandBars::GetScreentipMso(LPCTSTR idMso)
{
	CString result;
	static BYTE parms[] =
		VTS_BSTR;
	InvokeHelper(0x60030022, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms,
		idMso);
	return result;
}

CString _CommandBars::GetSupertipMso(LPCTSTR idMso)
{
	CString result;
	static BYTE parms[] =
		VTS_BSTR;
	InvokeHelper(0x60030023, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms,
		idMso);
	return result;
}

LPDISPATCH _CommandBars::GetImageMso(LPCTSTR idMso, long Width, long Height)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_BSTR VTS_I4 VTS_I4;
	InvokeHelper(0x60030024, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms,
		idMso, Width, Height);
	return result;
}

void _CommandBars::CommitRenderingTransaction(long hwnd)
{
	static BYTE parms[] =
		VTS_I4;
...
LPDISPATCH _CommandBarButton::GetPicture()
{
	LPDISPATCH result;
...
void _CommandBarButton::SetPicture(LPDISPATCH newValue)
{
	static BYTE parms[] =
		VTS_DISPATCH;
...
LPDISPATCH _CommandBarButton::GetMask()
{
	LPDISPATCH result;
...
void _CommandBarButton::SetMask(LPDISPATCH newValue)
{
	static BYTE parms[] =
		VTS_DISPATCH;
