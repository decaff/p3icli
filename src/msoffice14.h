...
public:
	...
	BOOL GetDisableCustomize();
	void SetDisableCustomize(BOOL bNewValue);
	BOOL GetDisableAskAQuestionDropdown();
	void SetDisableAskAQuestionDropdown(BOOL bNewValue);
...
public:
	...
	LPDISPATCH GetMask();
	void SetMask(LPDISPATCH newValue);
};
/////////////////////////////////////////////////////////////////////////////
