#!/bin/bash
#
# Exercise code that places some ascii char data with high order bits set
# in both caption and title shapes.
# This is necessarily a visual (eyeball) test.
#
logfile="c:/temp/ansi_log.txt"
testdata="test_data_files/ansi_log.txt"
script="test_data_files/ansi_script.txt"
