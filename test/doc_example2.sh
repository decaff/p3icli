#!/bin/bash
#
# Recreate the second example script displayed in p3icli's documentation.
# This is necessarily a visual (eyeball) test.
#
logfile="c:/temp/doc_example2_log.txt"
logfile_edited="c:/temp/doc_example_log_edited.txt"
testdata="test_data_files/doc_example2_log.txt"
script="test_data_files/doc_example2.txt"
