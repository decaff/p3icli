...
# (i.e., can be populated).  The pics and caps use alt text designators
# that include leading zeroes.  E.g., pic01, cap01, etc.

logfile="c:/temp/max_pics_caps_log.txt"
testdata="test_data_files/max_pics_caps_p3i_log.txt"
script="test_data_files/max_pics_caps_p3i_script.txt"
