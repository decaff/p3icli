...
script2="./test_data_files/slide_size_script2_a4_pre_2013.txt"
...
diff -bu test_data_files/slide_size_data1_a4_pre_2013.txt $logfile1
if [ $? -eq 0 ] ; then
...
diff -bu test_data_files/slide_size_data2_a4_pre_2013.txt $logfile2
if [ $? -eq 0 ] ; then
