...
#
logfile="c:/temp/v30_fix_3_log.txt"
logfile_edited="c:/temp/v30_fix_3_log_edited.txt"
testdata="test_data_files/v30_fix_3_log.txt"
...
p3icli -D -T 1300 -l $logfile $script
