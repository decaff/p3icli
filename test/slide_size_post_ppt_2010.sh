...
# only relevant when Office 2013 or later is installed....

logfile1=c:/temp/slide_size_log_file1.txt
logfile2=c:/temp/slide_size_log_file2.txt
script1="./test_data_files/slide_size_script1_post_2010.txt"
script2="./test_data_files/slide_size_script2_post_2010.txt"
...
diff -bu test_data_files/slide_size_data1_post_2010.txt $logfile1
if [ $? -eq 0 ] ; then
...
diff -bu test_data_files/slide_size_data2_post_2010.txt $logfile2
if [ $? -eq 0 ] ; then
