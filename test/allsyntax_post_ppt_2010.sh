...
# 2) features that die when deprecated by PPT (i.e., "save as html").
#
# only relevant for PPT post-2010.
#
# This is a self-checking test.

logfile="c:/temp/allsyntax_log.txt"
testdata="test_data_files/allsyntax_post_2010_log.txt"
script="test_data_files/allsyntax_post_2010_script.txt"
