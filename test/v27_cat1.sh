...
logfile="c:/temp/v27_cat1_log.txt"
logfile_edited="c:/temp/v27_cat_log_edited.txt"
testdata="test_data_files/v27_cat1_log.txt"
script="test_data_files/v27_cat1_script.txt"
...
echo
echo "Note: 1-slide test fails w/ PPT 2003 with a slide index OOR error"
echo "due to use of a newer master slide configuration (in the targeted tmplt)"
echo "that is not compatible with an older version of PPT."
echo
echo "testing category:"
echo "-----------------"
echo "copy src fmt on"
echo
