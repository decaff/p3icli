...
logfile="c:/temp/v27_cat2_log.txt"
testdata="test_data_files/v27_cat2_log.txt"
script="test_data_files/v27_cat2_script.txt"
...
# No need for debug switch in this test because it's not possible to
# "lose a presentation" when copy src fmt and 3rd party fix are both off.
